  ...
  <div>
    <b-container>
      <b-row no-gutters align-h="center" align-v="start">
        ...
        <b-col sm=12 md=2 lg=2 xl=2 align-self="start">
          ...
          <b-popover target="conversion-direction" triggers="focus hover" placement="bottom">
            It is only possible to extract an in-game save from some online emulator save state files.
      ...
      <b-row>
        <b-col>
          <div class="help">
            Please note that you must create an in-game save in the emulator before creating/downloading a save state. Only the in-game save can be converted.
          </div>
        </b-col>
      </b-row>
    </b-container>
