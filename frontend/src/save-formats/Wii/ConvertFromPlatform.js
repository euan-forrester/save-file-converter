...
export default (arrayBuffer, platformType) => {
  ...
  switch (platformType) {
    ...
    case 'VC-PCE':
      output = {
        saveData: arrayBuffer, // Turbografx-16 games have a strange format that looks encrypted or compressed, and not like what I see when I look at a save made by a PCEngine emulator. Not sure how to parse them further
        fileExtension: 'bup',
      };
      break;
