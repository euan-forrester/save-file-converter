...
0x54-0x55 : reserved (something for execution files?): https://github.com/flyinghead/flycast/blob/33833cfd1ed2d94d907223442fdb8cdafd8d5d80/core/hw/maple/maple_devs.cpp#L533
*/
...
const MAGIC_BYTES = Util.getFilledArrayBuffer(MAGIC_LENGTH, MAGIC_VALUE);
...
export default class DreamcastSystemInfo {
  ...
  static readSystemInfo(arrayBuffer) {
    ...
    const reserved = dataView.getUint16(RESERVED_OFFSET, LITTLE_ENDIAN);
    ...
    return {
      ...
      systemInfo: {
        ...
        sizeInBlocks: SYSTEM_INFO_SIZE_IN_BLOCKS,
      },
      fileAllocationTable: {
      ...
      iconShape,
      saveArea: {
        blockNumber: SAVE_AREA_BLOCK_NUMBER,
