...
const UNCOMPRESSED_DATA_FILENAME = `${DIR}/uncompressed_data.sav`;
...
describe('Flash cart - N64 - GB64 emulator save format', () => {
  it('should convert a GB64 emulator save made with an Everdrive 64 to raw format', async () => {
    ...
    ArrayBufferUtil.writeArrayBuffer(UNCOMPRESSED_DATA_FILENAME, gb64EmulatorSaveData.getRawArrayBuffer());
  });
