...
const GB_NEWER_VERSION_MAGIC2_TYPE = 'A';
...
const GB_MASTER_VERSION_MAGIC2_TYPE = 'B';
...
describe('Nintendo Switch Online - Gameboy', () => {
  it('should convert a raw GB save to NSO format', async () => {
    ...
    const nsoSaveData = NsoGameboySaveData.createFromRawData(rawArrayBuffer, GB_ROM_HASH, GB_VERSION_NUMBER, GB_MAGIC2_TYPE);
  ...
  it('should convert a NSO GB save to raw format', async () => {
    ...
    expect(ArrayBufferUtil.arrayBuffersEqual(nsoSaveData.getMagic2Type(), GB_MAGIC2_TYPE)).to.equal(true);
  ...
  it('should convert a raw newer version GB save to NSO format', async () => {
    ...
    const nsoSaveData = NsoGameboySaveData.createFromRawData(rawArrayBuffer, GB_NEWER_VERSION_ROM_HASH, GB_NEWER_VERSION_NUMBER, GB_NEWER_VERSION_MAGIC2_TYPE);
  ...
  it('should convert a NSO newer version GB save to raw format', async () => {
    ...
    expect(ArrayBufferUtil.arrayBuffersEqual(nsoSaveData.getMagic2Type(), GB_NEWER_VERSION_MAGIC2_TYPE)).to.equal(true);
    expect(ArrayBufferUtil.arrayBuffersEqual(nsoSaveData.getRawArrayBuffer(), rawArrayBuffer)).to.equal(true);
  });
  ...
  it('should convert a raw master version GBC save to NSO format', async () => {
    ...
    const nsoSaveData = NsoGameboySaveData.createFromRawData(rawArrayBuffer, GBC_MASTER_VERSION_ROM_HASH, GBC_MASTER_VERSION_NUMBER, GB_MASTER_VERSION_MAGIC2_TYPE);
  ...
  it('should convert a NSO master version GBC save to raw format', async () => {
    ...
    expect(ArrayBufferUtil.arrayBuffersEqual(nsoSaveData.getMagic2Type(), GB_MASTER_VERSION_MAGIC2_TYPE)).to.equal(true);
    expect(ArrayBufferUtil.arrayBuffersEqual(nsoSaveData.getRawArrayBuffer(), rawArrayBuffer)).to.equal(true);
  });
  ...
  it('should convert a raw dual compatibility GB/GBC save to NSO format', async () => {
    ...
    const nsoSaveData = NsoGameboySaveData.createFromRawData(rawArrayBuffer, GB_GBC_ROM_HASH, GB_GBC_VERSION_NUMBER, GB_GBC_MAGIC2_TYPE);
  ...
  it('should convert a NSO dual compatibility GB/GBC save to raw format', async () => {
    ...
    expect(ArrayBufferUtil.arrayBuffersEqual(nsoSaveData.getMagic2Type(), GB_GBC_MAGIC2_TYPE)).to.equal(true);
    expect(ArrayBufferUtil.arrayBuffersEqual(nsoSaveData.getRawArrayBuffer(), rawArrayBuffer)).to.equal(true);
  });
  ...
  it('should convert a raw GBC save to NSO format', async () => {
    ...
    const nsoSaveData = NsoGameboySaveData.createFromRawData(rawArrayBuffer, GBC_ROM_HASH, GBC_VERSION_NUMBER, GBC_MAGIC2_TYPE);
  ...
  it('should convert a NSO GBC save to raw format', async () => {
    ...
    expect(ArrayBufferUtil.arrayBuffersEqual(nsoSaveData.getMagic2Type(), GBC_MAGIC2_TYPE)).to.equal(true);
    expect(ArrayBufferUtil.arrayBuffersEqual(nsoSaveData.getRawArrayBuffer(), rawArrayBuffer)).to.equal(true);
  });
});
